...
if metodo_pagamento == 1:
    desconto = 0.10
    print(
        f'O valor final do produto será de R${valor_produto - (valor_produto * desconto)}')
    ...
    acrescimo = 0.20
    print(
        f'O valor final do produto será de R${valor_produto + (valor_produto * acrescimo)}')
    print(
        f'De forma parcelada, você irá pagar {parcelas} prestações de R${(valor_produto + (valor_produto * acrescimo)) / parcelas} cada')
else:
